...
public class SATSolverTestSample {
    ...
    public static void solveCNF(String file) {
        ...
        Environment e = SATSolverSample.solve(f);
    ...
    public static void main(String[] args) {
        ...
        String filename = "D:\\SUTD Stuffs\\GitHub\\2D_SATsolver\\50.001_Java\\Project-2D-starting\\sampleCNF\\s8Sat.cnf";
        solveCNF(filename);
